## This is the plot4.R file for a course assignment project, authored by 
## Brett E. Shelton
...
#Plot Voltage for dateTime with labels
...
#Plot Global Reactive Power for dateTime with labels
plot(twoDays$dateTime, twoDays$Global_reactive_power, type = "l",xlab = "",ylab = "Global Reactive Power")
